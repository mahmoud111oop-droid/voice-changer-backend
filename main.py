...
from fastapi.staticfiles import StaticFiles  # <-- ضفنا دي
...
# --- 🛠️ الجزء الجديد لربط الواجهة بالفولدر الحالي 🛠️ ---

# 1. فتح الصفحة الرئيسية عند الدخول على الرابط
@app.get("/")
async def read_index():
    return FileResponse('index.html')

# 2. السماح للسيرفر بقراءة ملف الـ app.js والـ CSS من نفس الفولدر
